  ...
  return (
    <section className={`parts-grid py-8 ${notosansjp.className}`}>
      <div className="hero-grid">
        ...
        <h2 className="items-start hero-catch text-herocatch z-10 opacity-90 uppercase ">
          marginal
        </h2>
        <h2 className="align-bottom hero-catch text-herocatch z-10 opacity-90 uppercase">
          design
        </h2>
      </div>
    </section>
