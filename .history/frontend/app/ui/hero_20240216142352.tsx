  ...
  return (
    <section className={`parts-grid py-8 ${notosansjp.className}`}>
      <div className="hero-grid">
        ...
        <div className="hero-button self-center justify-self-end z-10 border border-accent-clr-01 rounded-md text-white bg-accent-clr-01 ">
          <Button title="作品を見る" path="/graphics" p-/>
        </div>
      </div>
    </section>
  );
