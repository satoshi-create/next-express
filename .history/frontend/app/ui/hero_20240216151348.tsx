  ...
  return (
    <section className={`parts-grid py-8 ${notosansjp.className}`}>
      <div className="hero-grid">
        ...
        <h2 className="self-center hero-catch1 text-herocatch z-10 opacity-90 uppercase text-right sepia-0 lg:rotate-90">
          marginal
        </h2>
        <h2 className="self-end hero-catch1 text-herocatch z-10 opacity-90 uppercase text-right sepia-0">
          design
        </h2>
