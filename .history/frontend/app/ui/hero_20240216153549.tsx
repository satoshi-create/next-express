    ...
    <section className={`parts-grid py-8 ${notosansjp.className}`}>
      <div className="hero-grid">
        ...
        <div className="grid hero-logo grid-cols-2 place-items-center z-10  bg-primary-green-02 w-herologo h-herologo  text-herologo font-bold relative">
          ...
          <div className="w-herobar h-herobar bg-primary-green-02 absolute bottom-[-30px] right-[-20px] rotate-90 origin-top-rightright"></div>
        </div>
        <h2 className="self-center hero-catch1 text-herocatch z-10 opacity-90 uppercase text-right sepia-0 lg:ve lg:justify-self-start">
          marginal
        </h2>
        <h2 className="self-end hero-catch2 text-herocatch z-10 opacity-90 uppercase text-right sepia-0">
          design
        </h2>
        ...
        <div
          className={`${notosansjp.className}   hero-button self-center justify-self-end z-10 lg:self-center`}
        >
